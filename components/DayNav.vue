<template>
  <div class="flex items-center justify-between rounded-3xl px-1.5 py-1.5" style="background: var(--surface-2)">
    <button class="tap text-dim p-2.5 rounded-2xl" aria-label="Giorno precedente" @click="day.shiftDate(-1)">
      <ChevronLeft :size="19" />
    </button>
    ...
    <button class="tap p-2.5 rounded-2xl" :class="day.isToday ? 'text-faint opacity-40' : 'text-dim'" :disabled="day.isToday"
